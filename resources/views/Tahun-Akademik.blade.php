        ...
        <div class="col-lg-8">
          <div class="row">
            ...
            <div class="card info-card revenue-card">
              <div class="card-body">
                <h5 class="card-title badge border-success border-1 text-success">Tahun Akademik <span>| Ganjil 2023/2024</span></h5>

                <div class="d-flex align-items-center">
                  <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tambah Tahun Akademik Baru">
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="row g-3">
                <div class="col-6">
                  <label for="inputNanme4" class="form-label">Mulai</label>
                  <input type="date" class="form-control" id="inputNanme4">
                </div>
                <div class="col-6">
                  <label for="inputNanme5" class="form-label">Sampai</label>
                  <input type="date" class="form-control" id="inputNanme5">
                </div>
              </form>
            </div>
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-success">
                <a href="Tahun-Akademik.html">TAMBAHKAN</a>
              </button>
            </div>
          </div>  
        </div>
