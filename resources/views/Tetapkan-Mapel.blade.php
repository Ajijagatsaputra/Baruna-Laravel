...
<head>
  ...
  <title>Mata Pelajaran-Tetapkan Mapel</title>
                    ...
                    <div class="card info-card customers-card">
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary"><a href="Tetapkan-Mapel.html">TETAPKAN</a></button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal fade" id="verticalycentered12" tabindex="-1">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Konfirmasi Menbatalkan Penetapan Mata Pelajaran</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        Apakah yakin Mata Pelajaran Matematika akan dibatalkan?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">BATAL</button>
                                        <button type="submit" class="btn btn-danger"><a href="Tetapkan-Mapel.html">IYA</a></button>
                                    </div>
                                </div>
                            </div>
