          ...
          <div class="row">
              ...
              <div class="card info-card sales-card">
                <div class="filter" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="#">Semua Tingkat</a></li>
                  </ul>
                </div>
                <div class="card-body">
                  <h5 class="card-title">Siswa Aktif <span>| Tingkat I</span></h5>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>45</h6>
                      <span class="text-success small pt-1 fw-bold">12%</span> <span class="text-muted small pt-2 ps-1">dari total</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Guru Aktif <span>| Normatif</span></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a class="nav-link collapsed" href="Guru">
                        <i class="bi bi-people-fill"></i>
                    ...
                    <div class="ps-3">
                      <h6>64</h6>
                      <span class="text-success small pt-1 fw-bold">8%</span> <span class="text-muted small pt-2 ps-1">dari total</span>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Kelas <span>| Tingkat I</span></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a class="nav-link collapsed" href="kelas">
                        <i class="bi bi-person-square"></i>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card customers-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Mata Pelajaran <span>| Normatif</span></h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                      <a class="nav-link collapsed" href="Mata-Pelajaran">
                        <i class="bi bi-journals"></i>
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    <a href="Pelaksanaan-KBM" class="fw-bold text-dark">Pendidikan Jasmani dan Olah Raga di kelas XII Teknika </a>
                  </div>
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    <a href="Pelaksanaan-KBM" class="fw-bold text-dark">Pendidikan Agama di kelas XI Teknika </a>
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    <a href="Pelaksanaan-KBM" class="fw-bold text-dark">Ilmu Pengetahuan Alam di kelas XII Nautika </a>
                  </div>
                </div><!-- End activity item-->
