    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="Guru.html">Guru</a></li>          
    ...
    <section class="section dashboard">
      <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="tab-content pt-2" id="myTabContent">
                ...
                <!-- Title Card -->
                  <h5 class="card-title">Profil Guru <span>| Tubagus Faisal Bahri</span></h5>
        ...
        <div class="col-lg-4">
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Konfirmasi Mengubah Profil Guru</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      Apakah yakin data profil guru yang diubah sudah benar?
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">BATAL</button>
                      <button type="submit" class="btn btn-primary"><a href="Profil-Guru.html">IYA</a></button>
                    </div>
                  </div>
                </div>
              </div><!-- Akhir Modal Ubah Profil -->
              <!-- Modal Ubah Password -->
              <div class="modal fade" id="verticalycentered1" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      Apakah yakin akan Mengubah Username dan Password guru
                    </div>
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">BATAL</button>
                      <button type="submit" class="btn btn-primary"><a href="Guru.html">IYA</a></button>
                    </div>
                  </div>
                </div>
              </div> <!-- Akhir Modal Ubah Password -->
              <!-- Modal Tambah Dokumen -->
              <div class="modal fade" id="verticalycentered2" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Menambahkan Dokumen Guru</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form class="row g-3">
                      <div class="modal-body">
                      ...
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">BATAL</button>
                        <button type="submit" class="btn btn-primary"><a href="Profil-Guru.html">TAMBAHKAN</a></button>
                      </div>
                    </form><!-- End No Labels Form -->
                  </div>
                </div>
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Dokumentasi Guru <span>| 3 dokumen</span></h5>
