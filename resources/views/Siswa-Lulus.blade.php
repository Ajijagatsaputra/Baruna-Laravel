            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="card info-card revenue-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title badge border-success border-1 text-success">Total 500 Siswa <span>| Lulus</span></h5>
                            ...
                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tambah Lulusan">
                                <!--button type="button" class="btn btn-success rounded-pill btn-sm" data-bs-toggle="modal" data-bs-target="#verticalycentered">
                        ...
                        <table class="table datatable table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Aziz</a></td>
                                    <td>XII Teknika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizul</a></td>
                                    <td>XII Nautika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">3</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizah</a></td>
                                    <td>XI Nautika</td>
                                    <td>Perempuan</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">4</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizi</a></td>
                                    <td>XI Teknika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">5</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Aziziyah</a></td>
                                    <td>XII Nautika</td>
                                    <td>Perempuan</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">6</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizonk</a></td>
                                    <td>XII Teknika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">7</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizzzz</a></td>
                                    <td>XII Nautika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">8</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizatun</a></td>
                                    <td>XI Nautika</td>
                                    <td>Perempuan</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">9</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizuazi</a></td>
                                    <td>XI Teknika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">10</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizion</a></td>
                                    <td>XII Nautika</td>
                                    <td>Perempuan</td>
                                    <td>2022</td>
                                </tr>
                                    <tr>
                                    <th scope="row">11</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Aziiiiiiiiiiiiiz</a></td>
                                    <td>XII Teknika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">12</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizpol</a></td>
                                    <td>XII Nautika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">13</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizangela</a></td>
                                    <td>XI Nautika</td>
                                    <td>Perempuan</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">14</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizsetiawan</a></td>
                                    <td>XI Teknika</td>
                                    <td>Laki-laki</td>
                                    <td>2022</td>
                                </tr>
                                <tr>
                                    <th scope="row">15</th>
                                    <td><a class="row" href="Profil-Lulusan.html">Azizati</a></td>
                                    <td>XII Nautika</td>
                                    <td>Perempuan</td>
                                    <td>2022</td>
                                </tr>
            ...
            <table class="table datatable table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck8" checked>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck9" checked>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck10" checked>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck11" checked>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck12" checked>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck13" checked>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck14" checked>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="gridCheck15" checked>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-success" ><a href="Siswa-Lulus.html">LULUSKAN</a></button>
          </div>
        </div>
      </div>
    </div><!-- End Vertically centered Modal-->
